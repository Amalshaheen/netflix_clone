...
mixin _$DownloadsState {
  ...
  Option<Either<MainFailure, List<DownloadsModel>>>
      get downloadsSuccesOrFailure => throw _privateConstructorUsedError;
...
class _$DownloadsStateCopyWithImpl<$Res, $Val extends DownloadsState>
  ...
  $Res call({
    ...
    Object? downloadsSuccesOrFailure = null,
  }) {
    return _then(_value.copyWith(
      ...
      downloadsSuccesOrFailure: null == downloadsSuccesOrFailure
          ? _value.downloadsSuccesOrFailure
          : downloadsSuccesOrFailure // ignore: cast_nullable_to_non_nullable
...
class _$DownloadsStateImpl implements _DownloadsState {
  const _$DownloadsStateImpl(
      ...
      required this.downloadsSuccesOrFailure})
  ...
  @override
  String toString() {
    return 'DownloadsState(isLoading: $isLoading, downloads: $downloads, downloadsSuccesOrFailure: $downloadsSuccesOrFailure)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(
                    other.downloadsSuccesOrFailure, downloadsSuccesOrFailure) ||
                other.downloadsSuccesOrFailure == downloadsSuccesOrFailure));
  }
...
abstract class _DownloadsState implements DownloadsState {
  const factory _DownloadsState(
      ...
      required final Option<Either<MainFailure, List<DownloadsModel>>>
          downloadsSuccesOrFailure}) = _$DownloadsStateImpl;
